...
<style type="text/css">
body {
	background-image: url("/ORSProject0/resources/image/emerging-tech.jpg");
					...
					<div align="center">
						...
						<H2>
							<span class="glyphicon glyphicon-list"></span><b><b>&nbsp;<s:message
										code="header.userList"></s:message>
							</b></b>
						</H2>
					...
					<sf:form action="search" commandName="form" method="post">
						...
						<div class="container-fluid text-center">
							<div class="form-inline">
								...
								<div class="form-group  text-center">
									<label class="control-label" for="login"> <s:message
											code="user.label.login" /> :
									</label> <input type="text" class="form-control" name="login" size=15
										placeholder="${login}" value="">
								</div>

								&emsp;&emsp; <label class="control-label col-sm-1" for="role"
									style="padding-left: 50px; padding-top: 7px;"><b><font
										color="black"><s:message code="user.label.role"></s:message>:</font>
								</b></label>
								<div class="col-sm-2">
						...
						<c:choose>
							...
							<c:otherwise>
								...
								<div>
									...
									<c:choose>
										<c:when
											test="${list.size()==form.pageSize && !((userList.size()==form.pageSize*form.pageNo))}">
