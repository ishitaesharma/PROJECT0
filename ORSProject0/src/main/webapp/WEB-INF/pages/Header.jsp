...
<body>
	...
	<div class="container-fluid">
		<ul class="nav navbar-nav navbar-left"
			...
			<img src="/ORSProject0/resources/image/download.png" width="130"
				height="52" class="img-responsive">
			</a>
		</ul>
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<c:url value="/Welcome" />" id="dcolor">&emsp;<span
				class="glyphicon glyphicon-home" style="padding-right: 10px"></span>
			</a>
			...
			<ul class="nav navbar-nav navbar-right" style="background:">
				<c:if test="${empty sessionScope.user}">
					<li><a href="<c:url value="/Login" />" id="dcolor"
						...
						style="width: auto; font-family:"Sofia", sans-serif; color:#e0ebeb;"><span
					...
					<li><a href="<c:url value="/UserRegistration" />" id="dcolor">
							<font style="font-family:"Sofia", sans-serif; color:#e0ebeb">
								<span class="glyphicon glyphicon-user"
								style="font-size: 20px; margin-right: 10px;"></span> <s:message
									code="header.userRegistration"></s:message>
						</font>
					</a></li>
				</c:if>
						...
						aria-haspopup="true" aria-expanded="false"><span
							aria-hidden="true"></span><b> <span
								...
								style="font-size: 18px; margin-right: 3px;"></span> <s:message
									code="header.hii"></s:message> 
									<c:set var="name" value="${sessionScope.user.firstName}" /> 
									<c:set var="role" value='${sessionScope.role.name}' />
			...
			<li><a href="<c:url value="?lang=hi"></c:url>"><b style="color:	#FFFFFF"><s:message code="label.hindi"></s:message></b></a></li> --%>
				...
				<c:if test="${not empty sessionScope.user}">
					...
					<c:if test="${sessionScope.user.roleId == 2}">
						...
						<li class="dropdown"><a class="dropdown-toggle" id="dcolor"
							data-toggle="dropdown" href="#"><s:message code="header.user"></s:message>
								<span class="caret"></span></a>
							<ul class="dropdown-menu" style="background-color: wheat">
						...
						<li class="dropdown"><a class="dropdown-toggle" id="dcolor"
							data-toggle="dropdown" href="#"><s:message code="header.role"></s:message>
								<span class="caret"></span></a>
							<ul class="dropdown-menu" style="background-color: wheat">
